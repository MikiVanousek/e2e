...
def train(experiment: str, wandb_entity: str = "miki-aisle", wandb_project: str = "e2e-ttt"):
...
def main(
    ...
    train.remote(experiment=experiment, wandb_entity=wandb_entity, wandb_project=wandb_project)
